...
// netlify/functions/coach-partner-save.mjs
var coach_partner_save_exports = {};
__export(coach_partner_save_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(coach_partner_save_exports);
...
var handler = async (event) => {
  ...
  if (!record?.id) {
    return json(404, {
      error: "No coach profile found for this account. Make sure your email matches the Coaches table."
    });
  }
  ...
  try {
    ...
    return json(500, {
      error: "Could not save partner config to Airtable. Ensure the Coaches table has a 'Partner Config' long-text field."
    });
  }
};
...
//# sourceMappingURL=coach-partner-save.js.map
