...
// netlify/functions/_coach-mailer.mjs
var coach_mailer_exports = {};
__export(coach_mailer_exports, {
  sendCoachMagicLinkEmail: () => sendCoachMagicLinkEmail
});
module.exports = __toCommonJS(coach_mailer_exports);
var RESEND_ENDPOINT = "https://api.resend.com/emails";
function sender() {
  return process.env.EMAIL_FROM || "Grass2Pro <noreply@grass2pro.com>";
}
function siteBaseUrl() {
  return (process.env.COACH_MAGIC_LINK_BASE_URL || process.env.PARENT_PORTAL_BASE_URL || "").replace(/\/+$/, "");
}
...
async function sendCoachMagicLinkEmail({ to, rawToken, expiresInMinutes }) {
...
0 && (module.exports = {
  sendCoachMagicLinkEmail
});
//# sourceMappingURL=_coach-mailer.js.map
