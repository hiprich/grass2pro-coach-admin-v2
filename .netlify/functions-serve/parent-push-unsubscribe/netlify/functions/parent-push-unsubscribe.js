...
// netlify/functions/parent-push-unsubscribe.mjs
var parent_push_unsubscribe_exports = {};
__export(parent_push_unsubscribe_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(parent_push_unsubscribe_exports);
...
var handler = async (event) => {
  ...
  try {
    ...
    await airtableUpdate(pushSubsTable(), existing.id, {
      Active: false,
      "Last Used At": (/* @__PURE__ */ new Date()).toISOString()
    });
...
//# sourceMappingURL=parent-push-unsubscribe.js.map
